...
# All rights reserved.
#
# Dr. Zero Biomedical Adaptation - Iteration 3 Challenger Training
# Continues training proposer with improved solver from iteration 2
...
RESUME_PATH="./checkpoints/dr-zero-biomed/biomed_challenger_iter${prev_iter}_ratio${hop_ratio}_${algorithm}_group${grpo_group_size}-${reward_group_size}_${model_name}/global_step_100"
...
# Launch improved solver from iteration 2
echo "🤖 Starting solver server (iter ${prev_iter})..."
...
echo "🚀 Starting biomedical challenger training (iteration ${cur_iter})..."
